...
namespace Hammock.AssetView.Platinum.Tools.RC.RelayService.Common
{
    ...
    public class NamespaceHttpControllerSelector : DefaultHttpControllerSelector
    {
        ...
        public override HttpControllerDescriptor SelectController(HttpRequestMessage request)
        {
            ...
            {
                var descriptor = _duplicateControllerTypes.Value
                    .FirstOrDefault(n => string.Compare(n.Value.ControllerName, controllerNameAsString, true) == 0 && n.Value.ControllerType.Namespace == ns);

                if (descriptor.Value != null) return descriptor.Value;
            }
